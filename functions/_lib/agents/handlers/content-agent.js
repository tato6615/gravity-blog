...
// just created in the same cycle; content runs right after offer so it can claim
// the agent_tasks rows offer just created in the same cycle (same reasoning
// again — content-agent.js claims tasks addressed to 'content', which only
// exist once offer has matched a backlog product);
